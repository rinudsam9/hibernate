...
<a href="example3.do">Click here</a> to run the example. <!-- pass by reference --> <!-- uses map model which means springs takes care of everything -->
...
<a href="controller/example10?theme=default">Theme 2</a> | <a href="controller/example10?theme=red">Delete</a>
